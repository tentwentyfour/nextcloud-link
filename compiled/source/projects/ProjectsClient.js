...
var ProjectsClient = /** @class */ (function () {
    function ProjectsClient(baseURL, username, password) {
        var _this = this;
        this.baseURL = baseURL;
        this.username = username;
        this.addProject = function (project) { return __awaiter(_this, void 0, void 0, function () {
            var response, data, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new project_1.Project(project.owner, data.name, data.id, project.foreignId, url)];
                }
            });
        }); };
        var auth = {
