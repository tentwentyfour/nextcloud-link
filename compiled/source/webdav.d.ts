...
declare function rawSetFolderProperties(sanePath: string, properties: FolderProperties[]): Promise<void>;
...
export declare const setFolderProperties: typeof rawSetFolderProperties;
