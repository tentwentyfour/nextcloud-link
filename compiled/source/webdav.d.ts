...
export declare const getFolderFileDetails: (sanePath: string) => Promise<Webdav.ConnectionReaddirComplexResult[]>;
...
export declare const move: (saneFrom: string, toPath: string) => Promise<void>;
