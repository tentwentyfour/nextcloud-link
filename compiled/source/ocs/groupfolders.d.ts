...
export declare function ocsSetACL(groupfolderId: number, type: 'group' | 'user', id: string, path: string, permissions: string[], callback: (error: OcsHttpError, result?: boolean) => void): void;
