...
function createFileDetailProperty(namespace, namespaceShort, element, nativeType, defaultValue) {
    return {
        namespace: namespace,
...
exports.createFileDetailProperty = createFileDetailProperty;
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (error_1.statusCode) {
                            ...
                            else if (error_1.statusCode === 403) {
