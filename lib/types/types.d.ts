...
import { OcsShareType, OcsSharePermissions, type OcsEditUserField, type OcsGroupfolder, type OcsActivity, type OcsNewUser, type OcsShare, type OcsUser } from './ocs/types';
