...
export declare function ocsAddShare(path: string, shareType: OcsShareType, shareWith: string, permissions: OcsSharePermissions, password: string, callback: (error: OcsHttpError, result?: OcsShare) => void): void;
